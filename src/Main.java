...
class Admin extends User {
    ...
    public Admin() {
        ...
        userStudentList.add(new String[]{"10001", "John Doe", "Faculty of Engineering", "Computer Science"});
        userStudentList.add(new String[]{"10002", "Jane Smith", "Faculty of Science", "Physics"});
    }
    ...
    public void inputBook() {
        ...
        switch (choice) {
            case 1:
                Main.bookList.put(bookID, new String[]{title, author, String.valueOf(stock), "Story Book"});
                break;
            case 2:
                Main.bookList.put(bookID, new String[]{title, author, String.valueOf(stock), "History Book"});
                break;
            case 3:
                Main.bookList.put(bookID, new String[]{title, author, String.valueOf(stock), "Text Book"});
                break;
            default:
